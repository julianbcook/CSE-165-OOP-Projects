...
void appDrawScene() {
	...
	for (int i = 0; i < squares.size(); i++) {
		...
		glVertex2f(squares[i].x-  squares[i].length, squares[i].y+  squares[i].length);
		//glColor3f(squares[i].r, squares[i].g, squares[i].b);
		glVertex2f(squares[i].x + squares[i].length, squares[i].y + squares[i].length);
		//glColor3f(squares[i].r, squares[i].g, squares[i].b);
...
void appMouseFunc(int b, int s, int x, int y) {
	...
	squares.push_back(Square(mx, my, .05f ,red, green, blue));
...
void appMotionFunc(int x, int y) {
	...
	squares.push_back(Square(mx, my, .01f, red, green, blue));
...
void glutIdle()
{
	...
	{       
		...
		//if (squares[i].x == squares[i].x + 0.5f)
		//{
			//squares[i].x -= 0.5f;
			//squares[i].x = 0.01f;
		//}
